...
function WhatsApp() {
  return (
    <motion.div
      ...
      className="animate-bounce text-white fixed bottom-8 lg:bottom-8 right-12 border bg-[#25D366] z-50 border-transparent rounded-full w-[60px] h-[60px] flex justify-center items-center hover:bg-white hover:text-[#25D366] transition-colors duration-300 hover:scale-110 p-2 shadow-md shadow-slate-50 hover:shadow-[#25D366] "
    >
