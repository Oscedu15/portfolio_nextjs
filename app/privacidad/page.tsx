...
const Privacy = () => {
  return (
    <MaxWidthWrapper className="max-w-3xl mx-auto px-8 pb-10 bg-gradient-to-r dark:from-primary/10 dark:to-tertiary/10 from-slate-50 to-gray-300">
      <AnimationContainer delay={0.1} className="w-full">
        <h2 className="text-4xl md:text-6xl pt-24 lg:pt-32 font-heading font-bold text-center w-full">
        ...
        <p className="mt-4">
          En <strong>Oscedu</strong>, estamos comprometidos a proteger su
          privacidad. Esta Política de Privacidad explica cómo recopilamos,
          usamos, divulgamos y salvaguardamos su información cuando utiliza
        ...
        <p className="mt-8 text-muted-foreground">
          Cuando se registra para obtener una cuenta o utiliza nuestros
          servicios, podemos recopilar información personal que puede
          identificarlo, como su nombre, dirección de correo electrónico e
          información de pago.
        </p>
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          servicio, como direcciones IP, tipos de navegador, URLs de referencia
        ...
        <p className="mt-8">
          ...
          recopilar y almacenar información sobre sus interacciones con nuestro
          sitio web. Puede gestionar sus preferencias de cookies a través de la
        ...
        <div className="mt-8">
          ...
          <ul className="list-disc text-muted-foreground ml-8">
            <li>
              Enviarle actualizaciones, materiales promocionales y otra
              información relacionada con nuestros servicios.
            </li>
            <li>
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          terceros que nos asisten en la operación de nuestros servicios, como
          procesadores de pagos, servicios de correo electrónico y proveedores
          de alojamiento.
        </p>
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          su información personal contra el acceso no autorizado, pérdida o
          alteración. Sin embargo, ningún método de transmisión a través de
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          cumplir con los propósitos para los cuales fue recopilada, cumplir con
          nuestras obligaciones legales, resolver disputas y hacer cumplir
          nuestros acuerdos.
        </p>
        ...
        <p className="mt-8 text-muted-foreground">
          Tiene el derecho de acceder y actualizar su información personal.
          Puede hacerlo iniciando sesión en su cuenta y actualizando la
          configuración de su perfil.
        </p>

        <h3 className="text-lg mt-8">Opción de Exclusión</h3>
        <p className="mt-8 text-muted-foreground">
          Puede optar por no recibir correos electrónicos promocionales de
          nuestra parte siguiendo las instrucciones de cancelación de
          suscripción en esos correos. También puede contactarnos directamente
          para optar por no participar.
        </p>

        <h3 className="text-lg mt-8">Eliminación de Datos</h3>
        <p className="mt-8 text-muted-foreground">
          Tiene el derecho de solicitar la eliminación de su información
          personal. Por favor, contáctenos en support@Oscedu.com para hacer
          esta solicitud.
        </p>

        <h2 className="text-xl font-medium mt-12">Privacidad de los Niños</h2>
        <p className="mt-8 text-muted-foreground">
          Nuestros servicios no están dirigidos a individuos menores de 18 años.
          No recopilamos intencionalmente información personal de niños menores
          de 18. Si nos damos cuenta de que hemos recopilado información
          personal de un niño menor de 18, tomaremos medidas para eliminar dicha
          información.
        </p>
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          al suyo. Nos aseguraremos de que existan salvaguardias adecuadas para
          proteger su información personal cuando se transfiera a través de
          fronteras.
        </p>
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          Privacidad en nuestro sitio web y actualizando la fecha de Última
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          Privacidad, por favor contáctenos en oscaregarcialeon@gmail.com.
        </p>

        <p className="mt-8 font-medium">
          Al utilizar Oscedu, usted reconoce que ha leído, entendido y acepta
