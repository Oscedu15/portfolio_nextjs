...
<MaxWidthWrapper className="max-w-3xl mx-auto px-8 mb-40">
  <AnimationContainer delay={0.1} className="w-full">
    ...
    <p className="mt-4">
      Bienvenido a Linkify. Estos términos y condiciones describen las reglas y
      regulaciones para el uso del sitio web y los servicios de Linkify.
    </p>

    <h2 className="text-xl font-medium mt-8">Aceptación de los Términos</h2>

    <p className="mt-8 text-muted-foreground">
      Al acceder y utilizar Linkify, acepta y se compromete a cumplir con
    ...
    <p className="mt-8 text-muted-foreground">
      Linkify se reserva el derecho de modificar estos términos en cualquier
    ...
    <p className="mt-8">
      Para utilizar Linkify, debe tener al menos 18 años y ser capaz de
    ...
    <div className="mt-8">
      Acepta no utilizar Linkify para actividades ilegales o prohibidas,
    ...
    <p className="mt-8 text-muted-foreground">
      Linkify proporciona un servicio de acortamiento de URL que le permite
    ...
    <p className="mt-8 text-muted-foreground">
      Linkify ofrece analíticas para sus URLs acortadas. Acepta utilizar
    ...
    <p className="mt-8 text-muted-foreground">
      ...
      utilizando Linkify. Sin embargo, al subir o crear contenido, otorga a
      Linkify una licencia mundial, no exclusiva y libre de regalías para
    ...
    <p className="mt-8 text-muted-foreground">
      ...
      Linkify no respalda ni asume ninguna responsabilidad por el contenido
      del usuario.
    </p>
    ...
    <p className="mt-8 text-muted-foreground">
      Linkify se reserva el derecho de suspender o terminar su cuenta en
    ...
    <p className="mt-8 text-muted-foreground">
      Linkify se proporciona tal cual y según disponibilidad. No
    ...
    <p className="mt-8 text-muted-foreground">
      En ningún caso Linkify será responsable de daños indirectos, incidentales,
    ...
    <p className="mt-8 text-muted-foreground">
      ...
      India, sin tener en cuenta sus disposiciones sobre conflictos de leyes.
    </p>
